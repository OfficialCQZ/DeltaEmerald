...
const u8 gText_ThisIsAPokemon[] = _("And this…is what we call a “POKéMON.”{PAUSE 96}\p");
...
const u8 gText_BirchInTrouble[] = _("Choose a Pokémon."); // "PROF. BIRCH is in trouble!\nRelease a POKéMON and rescue him!"
...
const u8 gText_MovePokemon[] = _("Organize Pokémon");
const u8 gText_MoveItems[] = _("Organize Items");
const u8 gText_SeeYa[] = _("Power Off");
...
const u8 gText_BrawlyMatchCallDesc[] = _("THE BIG HIT"); // haha funny bighit #bts
