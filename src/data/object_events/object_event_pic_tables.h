...
const struct SpriteFrameImage gObjectEventPicTable_Lass_Delta[] = {
    overworld_frame(gObjectEventPic_Lass_Delta, 2, 4, 0),
    overworld_frame(gObjectEventPic_Lass_Delta, 2, 4, 1),
    overworld_frame(gObjectEventPic_Lass_Delta, 2, 4, 2),
    overworld_frame(gObjectEventPic_Lass_Delta, 2, 4, 3),
    overworld_frame(gObjectEventPic_Lass_Delta, 2, 4, 4),
    overworld_frame(gObjectEventPic_Lass_Delta, 2, 4, 5),
    overworld_frame(gObjectEventPic_Lass_Delta, 2, 4, 6),
    overworld_frame(gObjectEventPic_Lass_Delta, 2, 4, 7),
    overworld_frame(gObjectEventPic_Lass_Delta, 2, 4, 8),
};
