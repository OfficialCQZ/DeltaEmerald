...
const u32 gObjectEventPic_Lass_Delta[] = INCBIN_U32("graphics/object_events/pics/people/delta_emerald/lass.4bpp");
const u16 gObjectEventPaletteDelta1[] = INCBIN_U16("graphics/object_events/palettes/DELTA_01_LASS.gbapal");
