...
// static void NewGameBirchSpeech_SetDefaultPlayerName(u8); COMMENTED FOR DEBUG
...
static u32 InitMainMenu(bool8 returningFromOptionsMenu)
{
    ...
    if (returningFromOptionsMenu)
        ...
        BeginNormalPaletteFade(PALETTES_ALL, 0, 0x10, 0, RGB_BLACK); // fade to white -- In the Gen6 remakes, it should now fade from black.
