...
static void DebugAction_OpenDeltaMenu(u8);
...
static void DebugTask_HandleMenuInput_Delta(u8);
...
static void DebugAction_Delta_BGM_Trainer(u8);
...
static const u8 gDebugText_Delta_BGM_Trainer[] = _("BGM Trainer");
...
{
    [DEBUG_MENU_ITEM_DELTA]         = {gDebugText_DeltaEm,      DEBUG_MENU_ITEM_DELTA},
...
static const struct ListMenuItem sDebugMenu_Items_Delta[] =
{
    ...
    [DEBUG_DELTA_MENU_ITEM_BGMTRAINER] = {gDebugText_Delta_BGM_Wild, DEBUG_DELTA_MENU_ITEM_BGMTRAINER},
...
{
    [DEBUG_MENU_ITEM_DELTA]         = DebugAction_OpenDeltaMenu,
...
static void (*const sDebugMenu_Actions_Delta[])(u8) =
{
    ...
    [DEBUG_DELTA_MENU_ITEM_BGMTRAINER] = DebugAction_Delta_BGM_Trainer,
...
static const struct ListMenuTemplate sDebugMenu_ListTemplate_Delta =
{
    .items = sDebugMenu_Items_Delta,
    .moveCursorFunc = ListMenuDefaultCursorMoveFunc,
    .totalItems = ARRAY_COUNT(sDebugMenu_Items_Delta),
};
...
static void DebugTask_HandleMenuInput_Delta(u8 taskId)
{
    void (*func)(u8);
    u32 input = ListMenu_ProcessInput(gTasks[taskId].data[0]);
    ...
    if (gMain.newKeys & A_BUTTON)
    {
        ...
        if ((func = sDebugMenu_Actions_Delta[input]) != NULL)
            func(taskId);
    }
    else if (gMain.newKeys & B_BUTTON)
    {
...
static void DebugAction_OpenDeltaMenu(u8 taskId)
{
    PlaySE(DELTA_SE_SELECT);
    Debug_DestroyMenu(taskId);
    Debug_ShowMenu(DebugTask_HandleMenuInput_Delta, sDebugMenu_ListTemplate_Delta);
}
...
static void DebugAction_Delta_BGM_Soaring(u8 taskId)
{
...
static void DebugAction_Delta_BGM_Trainer(u8 taskId)
{
    m4aSongNumStart(MUS_VS_TRAINER);
}
